...
public class KmsEncryptDecryptExample {
    ...
    private static final String KEY_ID = "arn:aws:kms:ap-northeast-2:077672914621:key/b2d5e131-ea1f-4d1d-b177-63aaf7b95a0f";

    public static void main(String[] args) {
        String plainText = "Hello, like98100 here!";
